...
<head>
    ...
    <title>Order Delivered - {{ $order->reference }}</title>
</head>
...
<table width="600" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;">
    ...
    {{-- Header --}}
    <tr>
        <td style="background-color:#16a34a;padding:24px 30px;text-align:center;">
            <h1 style="margin:0;color:#ffffff;font-size:20px;font-weight:600;">Order Delivered</h1>
            <p style="margin:6px 0 0;color:#bbf7d0;font-size:14px;">{{ $order->reference }}</p>
        </td>
    </tr>
                    ...
                    <td style="padding:12px 20px;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                ...
                                <td style="font-size:14px;color:#16a34a;text-align:right;font-weight:700;">&#8358;{{ number_format($order->grand_total, 2) }}</td>
                            </tr>
                        </table>
                    </td>
                </tr>
    ...
    <tr>
        <td style="padding:24px 30px 0;">
            <h2 style="margin:0 0 14px;font-size:15px;color:#1f2937;border-bottom:1px solid #e5e7eb;padding-bottom:10px;">Items Delivered</h2>
            <table width="100%" cellpadding="0" cellspacing="0">
    ...
    <tr>
        <td style="padding:24px 30px;text-align:center;">
            <a href="{{ url('/account/orders/' . $order->id) }}" style="display:inline-block;background-color:#16a34a;color:#ffffff;text-decoration:none;padding:12px 28px;border-radius:6px;font-size:14px;font-weight:600;">View Your Order</a>
        </td>
    </tr>
